...
def _build_config() -> dict:
    ...
    # Optional third-party / proxy endpoint. Only the sidebar input is the explicit value;
    # env fallbacks (OPENAI_BASE_URL / ANTHROPIC_BASE_URL / BACKEND_URL) are resolved
    # downstream in trading_graph.resolve_base_url.
    backend_url = (st.session_state.get("llm_base_url") or "").strip()
